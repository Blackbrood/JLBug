	           ...
	           text: opami,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `𝐉𝐋𝐁𝐔𝐆`,
                            body: `𝐉𝐎𝐇𝐍𝐋𝐄𝐎`,
                            thumbnailUrl: `https://i.postimg.cc/mktZxY7f/Screenshot-20240914-105546.jpg`, 
                            sourceUrl: `https://whatsapp.com/channel/0029VamlYh41SWssaEvw4E2i`,
                            mediaType: 1,
...
case "ping": {
 ...
 await tdx.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `𝐉𝐋𝐁𝐔𝐆 𝑺𝒑𝒆𝒆𝒅 ➟ *${new Date() - startTime}* ᴍs `
        }
      }
    }, {});
  } 
break
	case "runtime":
                let pinga = ` 𝐉𝐋𝐁𝐔𝐆 ɦαร ɓεεɳ αcƭเѵε ƒσɾ ${runtime(process.uptime())}`
               tdx.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
...
\`✅ Example\` : addsrv JLBUG,26 December 2018,1,15,1,0/0,0
`)
let name = s[0];
let desc = s[1] || ''
let usr_id = s[2];
...
akunlo = "https://i.postimg.cc/mktZxY7f/Screenshot-20240914-105546.jpg" 
if (!u) return
...
let ctf = `❗Hello @${m.sender.split('@')[0]} , 𝐉𝐎𝐇𝐍𝐋𝐄𝐎 Just Gave You Access To The Following Account Panel > >

👤 Username: ${user.username}
🔐 Password: ${password}
🔗 Url: ${domain}`
tdx.sendMessage(u, { image: { url: 'https://i.postimg.cc/mktZxY7f/Screenshot-20240914-105546.jpg }, caption: ctf }, { quoted: m })
